...
public class ArticleView extends VerticalLayout {
    ...
    public ArticleView() {
        ...
        H1 title1 = new H1("Welcome to Article Page");
        mySection.add(title1);
        H2 title2 = new H2("1.Marriage Divorce");
        title2.addClassName("article-view-page-h2");
        mySection.add(title2);
        Paragraph mypParagraph = new Paragraph();
        mypParagraph.addClassName("article-view-page-h2");
        mypParagraph.setText(" If you want to apply for divorce in Bangladesh through a lawyer, you can follow these steps:\n" +
                "\n" +
        ...
        mySection.add(mypParagraph);

        H2 title3 = new H2("2.Tax Evasion");
        title3.addClassName("article-view-page-h3");
        mySection.add(title3);
        Paragraph mypParagraph1 = new Paragraph();
        mypParagraph1.addClassName("article-view-page-h2");
        mypParagraph1.setText("Tax evasion is a serious crime that involves deliberately underreporting or failing to report taxable income to the government. The legal procedure for tax evasion may vary depending on the country or jurisdiction in question. \n" +
                        "Here's an overview of the procedure in general:\n" +
        ...
        H2 title4 = new H2("3.Child adoption");
        ...
        mypParagraph2.setText("The legal procedure for child adoption in Bangladesh involves several steps and is governed by the Adoption Rules of 2018. Here's an overview of the process:\n" +
                "\n" +
        ...
        H2 title5 = new H2("4.Children custody after divorce");
        ...
        mypParagraph3.setText("In Bangladesh, the legal procedure for applying for child custody after divorce is governed by the Family Courts Ordinance of 1985. Here's an overview of the process:\n" +
                "\n" +
        ...
        H2 title6 = new H2("5.Murder case");
        ...
        mypParagraph4.setText("In Bangladesh, murder is a serious crime punishable under the Penal Code of 1860. The legal way of punishing a murder involves several steps, which include:\n" +
                "\n" +
        ...
        H2 title7 = new H2("6.Domestic violence on women");
        ...
        mypParagraph5.setText("In Bangladesh, domestic violence is a criminal offense under the Domestic Violence (Prevention and Protection) Act of 2010. If you are a victim of domestic violence, here are some legal steps you can take to fight it in court:\n" +
                "\n" +
        ...
        H2 title8 = new H2("7.Domestic violence on men");
        ...
        H2 title9 = new H2("8.Robbery case");
        ...
        mypParagraph7.setText("In Bangladesh, robbery is a criminal offense under the Penal Code of 1860. If you are a victim of robbery or have been accused of robbery, here are the legal procedures involved:\n" +
                "\n" +
        ...
        H2 title10 = new H2("9.Money embezzlement");
        ...
        mypParagraph8.setText("Money embezzlement, also known as theft or misappropriation of funds, is a criminal offense under the Penal Code of Bangladesh. If you have been a victim of money embezzlement or accused of embezzlement, here are the legal procedures involved:\n" +
                "\n" +
        ...
        H2 title11 = new H2("10.Rape case");
        ...
        mypParagraph9.setText("If you are a victim of rape in Bangladesh or know someone who is, here are the legal procedures involved in fighting a rape case:\n" +
                "\n" +
        ...
        H2 title12 = new H2("11.Public sexual harassment");
        ...
        mypParagraph10.setText("In Bangladesh, public sexual harassment is a criminal offense under the Penal Code of 1860. If you have been a victim of public sexual harassment or have witnessed such an incident, here are the legal procedures involved in fighting the case:\n" +
                "\n" +
        ...
        H2 title13 = new H2("12.Copyright infringement");
        ...
        mypParagraph11.setText("In Bangladesh, copyright infringement is a criminal offense under the Copyright Act, 2000. If you are the owner of a copyrighted work and believe that someone has infringed on your rights, here are the legal procedures involved in fighting a copyright case:\n" +
                "\n" +
        ...
        H2 title14 = new H2("13.Wage theft");
        ...
        mypParagraph12.setText("Wage theft is a criminal offense in Bangladesh, and employees have the right to file a complaint with the appropriate authorities to recover their stolen wages. Here are the legal procedures involved in fighting a wage theft case:\n" +
                "\n" +
        ...
        H2 title15 = new H2("14.Maid Abuse");
        title15.addClassName("article-view-page-h2");
        mySection.add(title15);
        Paragraph mypParagraph13 = new Paragraph();
        mypParagraph13.addClassName("article-view-page-h2");
        mypParagraph13.setText("If you are a victim or witness of maid abuse in Bangladesh, you can take the following legal steps to fight against it:\n" +
                "\n" +
