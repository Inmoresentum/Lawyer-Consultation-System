...
import com.cse471.project.data.service.UserService;
...
@Route("register-user")
@AnonymousAllowed
public class RegisterUser extends Div {
    ...
    private Button register = new Button("Submit Information");
